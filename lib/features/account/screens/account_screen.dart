...
import 'package:kleanitapp/features/account/screens/privacy_screen.dart';
import 'package:kleanitapp/features/account/screens/support_screen.dart';
import 'package:kleanitapp/features/account/screens/term_of_use_screen.dart';
...
class _TabProfileState extends State<TabProfile> {
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildProfileOption(context, "My Profile", "profile.svg", ProfileScreen()),
            _buildProfileOption(context, "My Address", "location.svg", AddressListScreen()),
            _buildProfileOption(context, "Privacy and policy", "privacy.svg", PrivacyScreen()),
            _buildProfileOption(context, "Terms and condition", "termuse.svg", TermOfUseScreen()),
            _buildProfileOption(context, "Contact support", "question.svg", SupportScreen()),
  ...
  _logout() async {
    try {
      ...
      prefs.remove(PrefResources.USER_ACCESS_TOCKEN);

      await _googleSignIn.signOut();
      await FirebaseAuth.instance.signOut();
    } finally {
      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_) => SplashScreen()), (predict) => false);
    }
  }
