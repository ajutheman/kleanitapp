...
class OrderTypeSelector extends StatefulWidget {
  ...
  const OrderTypeSelector({super.key, required this.onTypeSelected, this.initialSelection = SubscriptionType.SINGLE});

  @override
  State<OrderTypeSelector> createState() => _OrderTypeSelectorState();
}

class _OrderTypeSelectorState extends State<OrderTypeSelector> with SingleTickerProviderStateMixin {
