class UrlResources {
  ...
  static const String getScheduleList = "$baseUrl/customer/cart/list-time-schedules";
  ...
  static const String reviewUpdate = "$baseUrl/customer/reviews/add-customer-review";
  static const String tokenUpdate = "$baseUrl/customer/notification/fcm/register-token";
  static const String getWalletBalance = "$baseUrl/customer/profile/wallet-balance";
  static const String getWalletwalletdetails = "$baseUrl/customer/profile/wallet-details";
  static const String notificationList = "$baseUrl/customer/notification/list-notifications";
  static const String faqList = "$baseUrl/customer/faqs";
  static const String validateCoupon = "$baseUrl/customer/coupon-validate";

  static const String deleteAddress = "$baseUrl/customer/add-address/delete"; // 👈 added
}
