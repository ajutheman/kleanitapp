class AppWeeklySchedule {
  ...
  AppWeeklySchedule({required this.id, required this.weekNumber, required this.days, required this.startDate, required this.endDate});

  factory AppWeeklySchedule.fromJson(Map<String, dynamic> json) {
