...
class AppWriteReviewSection extends StatefulWidget {
  final int secondCategoryId;

  const AppWriteReviewSection({Key? key, required this.secondCategoryId}) : super(key: key);

  @override
  State<AppWriteReviewSection> createState() => _AppWriteReviewSectionState();
}

class _AppWriteReviewSectionState extends State<AppWriteReviewSection> {
