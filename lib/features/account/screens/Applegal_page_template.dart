...
class AppLegalPageTemplate extends StatelessWidget {
  final String title;
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    GestureDetector(
                      onTap: () => AppConstant.backToPrev(context),
                      child: Icon(Icons.arrow_back_ios, color: primaryColor), //
                      // SvgPicture.asset("assets/images/$iconPath", height: 24),
                    ),
                    SizedBox(width: 16),
                    Expanded(child: Text(title, style: TextStyle(fontSize: 24, fontWeight: FontWeight.w800, color: Colors.black))),
                  ],
                ),
                getVerSpace(FetchPixels.getPixelHeight(20)),
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Container(padding: EdgeInsets.only(bottom: 20), child: Text(content, style: TextStyle(fontSize: 16, color: Colors.black87, height: 1.5))),
                  ),
                ),
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: Padding(padding: const EdgeInsets.symmetric(horizontal: 8.0), child: Text("Chat on WhatsApp", style: TextStyle(fontSize: 16))),
...
void _sendEmail(BuildContext context, String email) async {
  ...
  try {
    if (await canLaunchUrl(intentUri)) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("No email app or Gmail browser support found.")));
    }
  } catch (e) {
