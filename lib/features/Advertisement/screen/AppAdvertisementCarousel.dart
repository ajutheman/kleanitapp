...
class AppAdvertisementCarousel extends StatefulWidget {
  final List<AppAdvertisement> advertisements;
  final void Function(AppAdvertisement) onBookTap;

  const AppAdvertisementCarousel({Key? key, required this.advertisements, required this.onBookTap}) : super(key: key);

  @override
  _AppAdvertisementCarouselState createState() => _AppAdvertisementCarouselState();
}

class _AppAdvertisementCarouselState extends State<AppAdvertisementCarousel> {
