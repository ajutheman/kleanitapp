...
import 'package:kleanit/features/categories/modle/category_model.dart';
      ...
      if (thirdCategory.oneInWeekPrice != null)
        {
          ...
          'frequency': 1,
          'price': thirdCategory.oneInWeekPrice
        },
      if (thirdCategory.twoInWeekPrice != null)
        {
          'label': '2 times per week',
          'frequency': 2,
          'price': thirdCategory.twoInWeekPrice
        },
      if (thirdCategory.threeInWeekPrice != null)
        {
          'label': '3 times per week',
          'frequency': 3,
          'price': thirdCategory.threeInWeekPrice
        },
      if (thirdCategory.fourInWeekPrice != null)
        {
          'label': '4 times per week',
          'frequency': 4,
          'price': thirdCategory.fourInWeekPrice
        },
      if (thirdCategory.fiveInWeekPrice != null)
        {
          'label': '5 times per week',
          'frequency': 5,
          'price': thirdCategory.fiveInWeekPrice
        },
      if (thirdCategory.sixInWeekPrice != null)
        {
          'label': '6 times per week',
          'frequency': 6,
          'price': thirdCategory.sixInWeekPrice
        },
      ...
      if (thirdCategory.onceInMonthPrice != null)
        {
          ...
          'frequency': 7,
          'price': thirdCategory.onceInMonthPrice
        },
      if (thirdCategory.twiceInMonthPrice != null)
        {
          'label': 'Twice per month',
          'frequency': 8,
          'price': thirdCategory.twiceInMonthPrice
        },
      if (thirdCategory.thriceInMonthPrice != null)
        {
          'label': 'Three times per month',
          'frequency': 9,
          'price': thirdCategory.thriceInMonthPrice
        },
    ];
            ...
            children: [
              ...
              Expanded(
                child: ListView(
                  padding: const EdgeInsets.all(16),
                  children: [
                    const Text('Available Rental Periods',
                        style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.w500,
                        )),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        if (selectedPricingIndex >= 0) {
                          frequency = pricingData[selectedPricingIndex]
                              ['frequency'] as int;
                        } else {
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    ...thirdCat.materials.map<Widget>((material) =>
                        _buildServiceItem(material.name, material.comment)),
                    const SizedBox(height: 24),
