...
import 'Appmap_picker_screen.dart';

class AppAddressFormScreen extends StatefulWidget {
  final AppCustomerAddress? address;

  const AppAddressFormScreen({super.key, this.address});

  @override
  State<AppAddressFormScreen> createState() => _AppAddressFormScreenState();
}

class _AppAddressFormScreenState extends State<AppAddressFormScreen> {
