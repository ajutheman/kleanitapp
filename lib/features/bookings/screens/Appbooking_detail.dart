...
import 'package:kleanitapp/features/bookings/screens/widgets/Appweekly_schedule_selector.dart';
import 'package:kleanitapp/presentation/widgets/Apperror_widget.dart';
...
import '../../home/Appwrite_review_section.dart';
...
class AppBookingDetail extends StatefulWidget {
  final String bookingId;

  const AppBookingDetail({super.key, required this.bookingId});

  @override
  State<AppBookingDetail> createState() => _AppBookingDetailState();
}

class _AppBookingDetailState extends State<AppBookingDetail> {
  AppBookingDetails? bookingDetails;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: getCustomFont("Order", 24, Colors.black, 1, fontWeight: FontWeight.w800, fontFamily: AppConstant.fontsFamily),
        actions: [
            ...
            BlocConsumer<BookingDetailBloc, BookingDetailState>(
              ...
              builder: (context, state) {
                if (state is BookingDetailLoading || state is CancelOrderLoading) {
                  ...
                  return Expanded(child: Center(child: AppMyErrorWidget(onRetry: () => loadOrderDetails(), message: state.message)));
                ...
                return Expanded(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      AppWriteReviewSection(secondCategoryId: bookingDetails!.items.first.thirdCategory.secondCatId),
                      getVerSpace(FetchPixels.getPixelHeight(30)),
                      //     ],
                      //   ),
                      // ),
  ...
  void showWorkingDaysDialog(BuildContext context, String orderId) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AppWeeklyScheduleSelector(orderId: orderId);
      },
    );
  }
              ...
              isDownloading
                  ...
                  : () async {
                    try {
                      ...
                      final bookingRepository = AppBookingRepository();
  ...
  void _openWhatsApp(BuildContext context, String phoneNumber, {AppBookingDetails? bookingDetails}) async {
