...
class AppAuthResponse {
  ...
  AppAuthResponse({required this.message, required this.token, required this.customer});

  factory AppAuthResponse.fromJson(Map<String, dynamic> json) {
    return AppAuthResponse(message: json['message'] as String, token: json['token'] as String, customer: Customer.fromJson(json['customer'] as Map<String, dynamic>));
  }
