...
import 'package:kleanitapp/features/categories/modle/Appcategory_model.dart';
...
class AppCategoryDetailScreen extends StatefulWidget {
  final String type;
  final AppMainCategory category;

  const AppCategoryDetailScreen({Key? key, required this.type, required this.category}) : super(key: key);

  @override
  State<AppCategoryDetailScreen> createState() => _AppCategoryDetailScreenState();
}

class _AppCategoryDetailScreenState extends State<AppCategoryDetailScreen> {
  ...
  void _addToCart({required int thirdCategoryId, required String type, int? subscriptionFrequency, required bool isDirectBooking}) {
    ...
    if (type == AppSubscriptionType.SUBSCRIPTION) {
