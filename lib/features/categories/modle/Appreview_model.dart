class AppReviewResponse {
  ...
  AppReviewResponse({required this.currentPage, required this.data, required this.total});

  factory AppReviewResponse.fromJson(Map<String, dynamic> json) {
    return AppReviewResponse(currentPage: json['current_page'], data: (json['data'] as List).map((e) => Review.fromJson(e as Map<String, dynamic>)).toList(), total: json['total']);
  }
}
