...
class AppNotificationListScreen extends StatefulWidget {
  const AppNotificationListScreen({Key? key}) : super(key: key);

  @override
  State<AppNotificationListScreen> createState() => _AppNotificationListScreenState();
}

class _AppNotificationListScreenState extends State<AppNotificationListScreen> with TickerProviderStateMixin {
  ...
  Widget _buildNotificationsList(List<AppNotificationModel> notifications) {
  ...
  Widget _buildNotificationCard(AppNotificationModel notification, int index) {
