...
class AppWeeklyScheduleSelector extends StatefulWidget {
  final String orderId;

  const AppWeeklyScheduleSelector({super.key, required this.orderId});

  @override
  State<AppWeeklyScheduleSelector> createState() => _AppWeeklyScheduleSelectorState();
}

class _AppWeeklyScheduleSelectorState extends State<AppWeeklyScheduleSelector> with TickerProviderStateMixin {
  ...
  Widget contentBox(AppWeeklySchedule schedule) {
