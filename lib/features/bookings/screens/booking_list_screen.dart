...
class BookingList extends StatefulWidget {
  ...
  const BookingList({Key? key, this.filterTag = "All"}) : super(key: key);
...
class _BookingListState extends State<BookingList> {
  ...
  Widget buildBookingCard(BuildContext context, BookingModel booking) {
    return Container(
  ...
  Widget _buildHeaderRow(BookingModel booking) {
    return Row(
  ...
  Widget _buildDateInfo(BookingModel booking) {
    return Column(
      children: [
        Row(
          children: [
  ...
  Widget _buildScheduleInfo(BookingModel booking) {
    return Row(
      children: [
  ...
  Widget _buildItemsSummary(BookingModel booking) {
