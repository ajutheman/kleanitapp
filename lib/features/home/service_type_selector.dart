...
class ServiceTypeSelector extends StatefulWidget {
  ...
  const ServiceTypeSelector(
      ...
      this.initialSelection = SubscriptionType.SINGLE});
...
class _ServiceTypeSelectorState extends State<ServiceTypeSelector>
  ...
  void initState() {
    ...
    _tabController = TabController(
        length: 2,
        vsync: this,
        initialIndex: _selectedType == SubscriptionType.SINGLE ? 0 : 1);
    ...
    return Container(
      ...
      child: Theme(
        ...
        child: TabBar(
          ...
          indicatorColor: Colors.transparent, // ✅ Prevents default underline
          ...
          tabs: [
            _buildTab(
              title: "Single",
              subtitle: "For hours & days",
              icon: Icons.watch_later_outlined,
              isSelected: _tabController.index == 0,
            ),
            _buildTab(
              title: "Subscriptions",
              subtitle: "For months & years",
