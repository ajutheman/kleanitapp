...
import 'package:kleanit/features/bookings/screens/widgets/weekly_schedule_selector.dart';
import 'package:kleanit/presentation/widgets/error_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: getCustomFont("Order", 24, Colors.black, 1,
            fontWeight: FontWeight.w800, fontFamily: Constant.fontsFamily),
        actions: [
          ...
          children: [
            BlocConsumer<BookingDetailBloc, BookingDetailState>(
              ...
              builder: (context, state) {
                ...
                final statusColor =
                    _getStatusColor(bookingDetails!.orderStatus);
                final statusLabel =
                    _getStatusLabel(bookingDetails!.orderStatus);
                return Expanded(
                  flex: 1,
                  child: ListView(
                    primary: true,
                    ...
                    children: [
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      getCustomFont(
                                          "Service Type", 14, Colors.black87, 1,
                                          fontWeight: FontWeight.w600),
                                      getCustomFont(
                                          "Price", 14, Colors.black87, 1,
                                          fontWeight: FontWeight.w600),
                                    ],
                                  ),
                                  getVerSpace(FetchPixels.getPixelHeight(
                                      10)), // Spacing after header
                              ...
                              Container(
                                padding: EdgeInsets.all(
                                    FetchPixels.getPixelHeight(12)),
                                decoration: BoxDecoration(
                                  color: bookingDetails!.paymentStatus
                                              .toLowerCase() ==
                                          'paid'
                                    ...
                                    children: [
                                      Column(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                        children: [
                                          getCustomFont("Subscription Service",
                                              14, Colors.blue, 1,
                                              fontWeight: FontWeight.w600),
                                          getVerSpace(
                                              FetchPixels.getPixelHeight(4)),
                                      ...
                                      InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: getCustomFont("Select Days",
                                              13, Colors.white, 1,
                      ...
                      if (bookingDetails!.orderStatus.toLowerCase() ==
                              'confirmed' ||
                          bookingDetails!.orderStatus.toLowerCase() ==
                              'in_progress') ...[
                        getPaddingWidget(
                          EdgeInsets.symmetric(
                              horizontal: FetchPixels.getPixelWidth(20)),
                          Column(
                            ...
                            children: [
                              ...
                              getCustomFont(
                                  "Service Provider", 20, Colors.black, 1,
                                    ...
                                    Expanded(
                                      child: Column(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                        children: [
                                          getCustomFont("Service Provider", 14,
                                              Colors.black87, 1,
                                              fontWeight: FontWeight.w600),
                                          getVerSpace(
                                              FetchPixels.getPixelHeight(4)),
                      ...
                      getPaddingWidget(
                        ...
                        Column(
                          ...
                          children: [
                            getVerSpace(FetchPixels.getPixelHeight(30)),
                            getCustomFont(
                                "Booking Options", 20, Colors.black, 1,
                                fontWeight: FontWeight.w800),
                            getVerSpace(FetchPixels.getPixelHeight(16)),
...
// Add this inside the build method where you list the booking options
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () => _openWhatsApp(
                                      ...
                                      bookingDetails:
                                          bookingDetails, // Pass the booking details here
                            ...
                            getButtonWithIcon(
                              ...
                              Colors.black,
                              () {
                                _showServiceWarrantyDialog(
                                    context, bookingDetails!.orderNumber);
                              },
                              16,
                              weight: FontWeight.w600,
                              buttonHeight: FetchPixels.getPixelHeight(60),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            getCustomFont(
                                "Service Details", 18, Colors.black, 1,
                                fontWeight: FontWeight.w700),
                            getVerSpace(FetchPixels.getPixelHeight(16)),

                            // Service items
                            ...bookingDetails!.items.map((item) => Container(
                                  margin: EdgeInsets.only(
                      ...
                      WriteReviewSection(
                          secondCategoryId: bookingDetails!
                              .items.first.thirdCategory.secondCatId),
                      getVerSpace(FetchPixels.getPixelHeight(30)),
                      //     ],
                      //   ),
                      // ),
  ...
  Future<Map<String, dynamic>?> showCancelOrderDialog(BuildContext context,
          ...
          onPressed: isDownloading
              ...
              : () async {
                  try {
                    ...
                    final filePath =
                        "${directory.path}/invoice_$encryptedInvoiceId.pdf";
                    ...
                    if (response.statusCode == 200) {
                      ...
                      print(
                          "Failed to download invoice. Status Code: ${response.statusCode}");
  ...
  void _openWhatsApp(BuildContext context, String phoneNumber,
    ...
    if (bookingDetails != null) {
      ...
      message +=
          "Order Date: ${DateFormat('d MMMM, y').format(DateTime.parse(bookingDetails.createdAt).toLocal())}\n";
