      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildProfileOption(
                context, "My Profile", "profile.svg", ProfileScreen()),
            _buildProfileOption(
                context, "My Address", "location.svg", AddressListScreen()),
            _buildProfileOption(
                context, "Privacy and policy", "privacy.svg", PrivacyScreen()),
            _buildProfileOption(context, "Terms and condition", "termuse.svg",
                TermOfUseScreen()),
            _buildProfileOption(
                context, "Contact support", "question.svg", SupportScreen()),
            ...
            children: [
              Container(
                ...
                child:
                    ...
                    //     :
                    Image.asset(
                  "assets/icon/default-avatar.png",
                  fit: BoxFit.fill,
                ),
              ),
  ...
  void _showReauthRequiredDialog() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text(
            "Please log in again to confirm your identity before deleting your account."),
        actions: [
          TextButton(
            onPressed: () => Navigator.of(context).pop(),
            child: const Text("OK"),
