...
import '../account/screens/Appaccount_screen.dart';
import '../bookings/screens/Apptab_booking.dart';
import '../cart/screens/Appcarts_screen.dart';
...
class AppHomeMainView extends StatelessWidget {
  AppHomeMainView({super.key});
  ...
  final List<Widget> _screens = const [AppHomeScreen(), AppTabBookings(), AppCartListScreen(), AppTabProfile()];
