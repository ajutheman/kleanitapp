...
import 'package:kleanitapp/features/cart/model/Appcart.dart';

import '../../../core/constants/Sypdo_constants.dart';
import '../../../core/theme/sypd_color.dart';
import '../../cart/bloc/cart_bloc.dart';
import '../../cart/bloc/cart_event.dart';
import '../../cart/bloc/cart_state.dart';
import '../../home/AppReviewSection.dart';
import '../../home/Apphome_main.dart';
import '../../order/presentation/Apporder_screen.dart';
...
class AppCategoryDetailScreenforadd extends StatefulWidget {
  final int mainCategoryId;
  final String type;
  final dynamic category;

  const AppCategoryDetailScreenforadd({Key? key, required this.mainCategoryId, required this.type, this.category}) : super(key: key);

  @override
  State<AppCategoryDetailScreenforadd> createState() => _AppCategoryDetailScreenforaddState();
}

class _AppCategoryDetailScreenforaddState extends State<AppCategoryDetailScreenforadd> {
      ...
      body: BlocConsumer<CartBloc, CartState>(
        ...
        builder: (context, cartState) {
          ...
          return BlocProvider<CategoryDetailBloc>(
            create: (context) => CategoryDetailBloc(repository: AppCategoryDetailRepository(), mainCategoryId: widget.category.id, type: widget.type)..add(LoadCategoryDetail()),
  ...
  Widget _buildItems(List<FirstCategory> categories, {required List<AppCart> carts}) {
  ...
  Widget _buildApartmentList(FirstCategory category, List<AppCart> carts) {
    return KeyedSubtree(
  ...
  Widget _buildApartmentCard(BuildContext context, SecondCategory category, List<AppCart> carts) {
    return Container(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text('From AED ${thirdCat.price}', style: TextStyle(color: primaryColor, fontWeight: FontWeight.bold, fontSize: 12)),
                                  ),
                                ],
                              ),
  ...
  void _showPriceOrViewToCart(BuildContext context, ThirdCategory thirdCat, bool isCarted, {required bool isDirectBooking}) {
    if (!isCarted) {
      if (widget.type == AppSubscriptionType.SINGLE) {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Select your preferred rental period', style: TextStyle(fontSize: 14, color: Colors.grey[600])),
                          ],
                        ),
                      ),
                      ...
                      Expanded(
                        child: ListView(
                          ...
                          children: [
                            ...
                            Text('Available Rental Periods', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.grey[800])),
                            const SizedBox(height: 16),
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                ...
                                                '$week in a week',
                                                style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: isSelected ? primaryColor : Colors.grey[800]),
                                              ),
                                              if (week > 1)
                                                Text(
                                                  'Save ${savePercentage}% compared to weekly rate',
                                                  style: TextStyle(fontSize: 13, color: isSelected ? primaryColor : Colors.grey[600]),
                                                ),
                                            ],
                                          ),
                                        ),
                                        ...
                                        Text(
                                          'AED ${amount.toInt()}',
                                          style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: isSelected ? primaryColor : Colors.grey[800]),
                                        ),
                                      ],
                                    ),
                                  ),
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text('AED ${singlePrice.toInt()}', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.grey[800])),
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text('AED ${singlePrice.toInt()}', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: primaryColor)),
                              ],
                            ),
                          ],
                        ),
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text('Total Amount:', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.grey[800])),
                          Text('AED ${singlePrice.toInt()}', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: primaryColor)),
                        ],
                      ),
                      const SizedBox(height: 16),
                      ...
                      Expanded(
                        child: ListView(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 12),
                            ...thirdCat.materials.map<Widget>((material) => _buildServiceItem(material.name)),
                            const SizedBox(height: 24),

                            AppReviewSection(secondCatId: secondCat.id),
                          ],
                        ),
                      ),
...
void _gotoBookScreen(BuildContext context, int cartThirdId) async {
  ...
  await for (var state in cartBloc.stream) {
    if (state is CartLoaded) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (_) => AppOrderConfirmationScreen(carts: [cart])));
      break;
    }
  }
}
