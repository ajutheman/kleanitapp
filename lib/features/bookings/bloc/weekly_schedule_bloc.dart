...
class WeeklyScheduleBloc
  ...
  WeeklyScheduleBloc({required this.bookingRepository})
      : super(WeeklyScheduleInitial()) {
    on<FetchWeeklySchedule>(_onFetchSchedule);
    on<UpdateWeeklySchedule>(_onUpdateSchedule);
  }

  Future<void> _onFetchSchedule(
      FetchWeeklySchedule event, Emitter<WeeklyScheduleState> emit) async {
  ...
  Future<void> _onUpdateSchedule(
      UpdateWeeklySchedule event, Emitter<WeeklyScheduleState> emit) async {
    emit(WeeklyScheduleLoading());
    try {
