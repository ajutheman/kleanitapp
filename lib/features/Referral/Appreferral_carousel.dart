...
class AppReferralCarousel extends StatefulWidget {
  final List<AppReferalAdvertisement> referalAds;
  final double height;

  const AppReferralCarousel({Key? key, required this.referalAds, required this.height}) : super(key: key);

  @override
  _AppReferralCarouselState createState() => _AppReferralCarouselState();
}

class _AppReferralCarouselState extends State<AppReferralCarousel> {
