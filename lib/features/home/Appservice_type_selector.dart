...
class AppServiceTypeSelector extends StatefulWidget {
  final Function(String) onTypeSelected;
  final String initialSelection;

  const AppServiceTypeSelector({super.key, required this.onTypeSelected, this.initialSelection = AppSubscriptionType.SINGLE});

  @override
  State<AppServiceTypeSelector> createState() => _AppServiceTypeSelectorState();
}

class _AppServiceTypeSelectorState extends State<AppServiceTypeSelector> with SingleTickerProviderStateMixin {
