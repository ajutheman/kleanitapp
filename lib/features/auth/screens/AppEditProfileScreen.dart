...
import '../../profile/model/Appcustomer_model.dart';

class AppEditProfileScreen extends StatefulWidget {
  final bool isFirstTimeGoogleLogin;

  const AppEditProfileScreen({super.key, this.isFirstTimeGoogleLogin = false});
...
class _AppEditProfileScreenState extends State<AppEditProfileScreen> {
  ...
  void _setFormData(AppCustomerModel customer) {
  ...
  Future<void> _loadCustomerFromLocal() async {
    ...
    if (jsonString != null) {
      ...
      final customer = AppCustomerModel.fromJson(json);
